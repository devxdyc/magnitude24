...
async function Page() {
  ...
  // return (
  //   <div classNameNameName="container mx-auto p-4 rounded-xl mt-6">
  //     <div classNameNameName="overflow-x-auto border rounded-xl border-gray-100 overflow-hidden ">
  //       <table classNameNameName="min-w-full  shadow-md rounded-xl border  overflow-hidden border-zinc-300">
  //         <thead classNameNameName="bg-gray-900">
  //           <tr>
  //             <th classNameNameName="py-3 px-6 text-left text-sm font-medium text-white uppercase tracking-wider">
  //               Category
  //             </th>
  //             <th classNameNameName="py-3 px-6 text-left text-sm font-medium text-white uppercase tracking-wider">
  //               Name
  ...
  //               Date
  //             </th>
  //             <th classNameNameName="py-3 px-6 text-left text-sm fonhjt-medium text-white uppercase tracking-wider">
  //               Time
  //             </th>
  //             <th classNameNameName="py-3 px-6 text-left text-sm font-medium text-white uppercase tracking-wider">
  //               Venue
  ...
  //           </tr>
  //         </thead>
  //         <tbody classNameNameName=" divide-y divide-gray-700">
  //           {data &&
  //             data.map((item, index) => (
  //               <tr key={index} classNameNameName="hover:bg-gray-900">
  //                 <td classNameNameName="py-4 px-6 whitespace-nowrap text-sm font-medium text-white">
  //                   {item.category_name}
  //                 </td>
  //                 <td classNameNameName="py-4 px-6 whitespace-nowrap text-sm text-white">
  //                   {item.name}
  //                 </td>
  //                 <td classNameNameName="py-4 px-6 whitespace-nowrap text-sm text-white">
  //                   {item.start_date}
