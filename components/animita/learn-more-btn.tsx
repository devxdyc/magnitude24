...
export default function ArrowButton({
  ...
  return (
    <button
      ...
      {...props}
      className={cn(
        "group relative inline-flex items-center justify-center overflow-hidden rounded-full border-2 border-purple-400 bg-background md:px-6 md:py-3 md:font-medium shadow-md transition duration-300 ease-out",
        className
      )}
    >
      <span
