...
const details = [
  {
    year: 2013,
    title: "The Beginning",
    description: `When I say "Incredible", you say "India". When I say YouthVibe you say it's Mine. 2013 was our first ever step into LPU’s Global fest Youthvibe. Based on Our Country’s huge cultural diversity, the fest was a mega hit among our youth population`,
  },
  {
    year: 2014,
  ...
  },
  {
    ...
    description: `Youth vibe 2016 recreated all our favourite cartoon characters from the 90s. Introducing the very popular Coke Studio Concert, we welcomed the very popular Diljit Dosanjh and Gurdas Mann to our campus.`,
  },
  {
    year: 2018,
  ...
  // Add other details as per your data
];
