...
const formSchema = z.object({
  ...
  team: z.string().nonempty("Specify team size"),
  teamname: z.string().nonempty("Team name is required"),
  teammember1: z.string(),
  teammember2: z.string(),
  teammember3: z.string(),
  others: z.string(),
});

type FormData = z.infer<typeof formSchema>;

export default function CulturalRegistrationForm({ id }: { id: string }) {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8  m-10 ">
      ...
      <form className="my-8" onSubmit={handleSubmit(onSubmit)}>
        ...
        <LabelInputContainer className="mb-4">
          <Label htmlFor="cource">Team Name</Label>
          <Input
            id="teamname"
            placeholder=""
            type="text"
        ...
        <LabelInputContainer className="mb-4">
          <Label htmlFor="hostler">Team Size</Label>
          {/* <Input
            id="hostler"
            placeholder=""
            type=""
          ...
          >
            <option value="solo" className="bg-transparent text-foreground p-2">
              Solo
            </option>
            <option value="Duo" className="bg-transparent text-foreground p-2">
              Duo
            </option>
            <option
              value="Group"
        ...
        {watchTeam === "Duo" || watchTeam === "Group" ? (
          <LabelInputContainer className="mb-4">
            <Label htmlFor="cource">Member-1 name</Label>
            <Input
              id="teammember1"
              placeholder=""
              type="text"
        ...
        {watchTeam === "Group" ? (
          <>
            <LabelInputContainer className="mb-4">
              <Label htmlFor="cource">Member-2 name</Label>
              <Input
                id="teammember2"
                placeholder=""
                type="text"
            ...
            <LabelInputContainer className="mb-4">
              <Label htmlFor="cource">Member-3 name</Label>
              <Input
                id="teammember3"
                placeholder=""
                type="text"
            ...
            <LabelInputContainer className="mb-4">
              <Label htmlFor="cource">Other</Label>
              <Input
                id="other"
                placeholder=""
                type="text"
